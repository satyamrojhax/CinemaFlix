...
export const TvShowOverviewSection: React.FC<TvShowOverviewSectionProps> = ({
  ...
  const firstReleaseYear = tv.first_air_date ? new Date(tv.first_air_date).getFullYear() : 'N/A';
  const lastReleaseYear = tv.last_air_date ? new Date(tv.last_air_date).getFullYear() : 'N/A';
